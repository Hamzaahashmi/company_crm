...
<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <!-- Column -->
                <div data-id="clockin" class=" clock col-md-6 col-lg-2 col-xlg-3">
                    <div class="card card-hover">
                        <div class="box clockbg  @if($timelogs == 0) bg-success @else bg-danger @endif text-center">
                            <h1 class="font-light text-white">
                                <i class="mdi mdi-clock"></i>
                            </h1>
                            <h6 class="text-white clocktext"> @if($timelogs == 0) ClockIn @else ClockOut @endif </h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-2 col-xlg-3">
                    <div class="card card-hover">
                        <div class="box bg-primary text-center">
                            ...
                            <h6 class=""><a class="text-white" href='{{route("calender")}}'>Calnedar</a></h6>
                        </div>
                    </div>
                </div>
                <!-- Column -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-md-flex align-items-center">
                                <div>
                                    <h4 class="card-title">Previous Time Logs</h4>
                                </div>
                            </div>
                            <div class="row">
                                <!-- column -->
                                                ...
                                                <table id="zero_config"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-white">Time Consumed</th>

                                                        </tr>
                                                    </thead>
                                                    <tbody class="table-body">
                                                        @foreach ($timelog_record as $row)
                                                        <tr>
                                                            <td>{{$row['start_time']}}</td>
                                                            <td>{{$row['end_time']}}</td>
                                                            <td>{{timecal($row['start_time'],$row['end_time'])}}</td>
                                    ...
                                    <li class="list-group-item todo-item" data-role="task">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label w-100 mb-0 todo-label" for="customCheck">
                                                <span class="todo-desc fw-normal">Lorem Ipsum is simply dummy text of
                                                    the printing
...
function drawChart() {
  ...
  var options = {'title':'Storage', 'width':550, 'height':400};
    ...
    $(document).on('click', '.clock', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data === 'create') {
                    $('.clocktext').text('ClockOut');
                    $('.clockbg').removeClass('bg-success');
                    $('.clockbg').addClass('bg-danger');

                } else {
                    $('.clocktext').text('ClockIn')
                    $('.clockbg').addClass('bg-success');
                    $('.clockbg').removeClass('bg-danger');
