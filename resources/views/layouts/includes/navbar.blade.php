             ...
             <ul id="sidebarnav" class="pt-4">
                 <li class="sidebar-item">
                     <a class="sidebar-link waves-effect waves-dark sidebar-link" data-toggle="modal"
                         data-target="#addusermodel" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span
                             class="hide-menu">Add User</span></a>

                 </li>
                 <li class="sidebar-item">
                     <a class="sidebar-link waves-effect waves-dark sidebar-link" data-toggle="modal"
                         data-target="#addcourseModal" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span
                             class="hide-menu">New Courses</span></a>
                 </li>
                 <li class="sidebar-item">
                     <a class="sidebar-link waves-effect waves-dark sidebar-link searchstudent" aria-expanded="false"><i
                             class="mdi mdi-chart-bubble"></i><span class="hide-menu">View Students</span></a>
                 </li>
                 <li class="sidebar-item">
                     <a class="sidebar-link waves-effect waves-dark sidebar-link searchteacher" aria-expanded="false"><i
                             class="mdi mdi-border-inside"></i><span class="hide-menu">View teachers</span></a>
                 </li>
